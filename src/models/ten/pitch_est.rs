// Adapted from ten-vad-rs 0.1.7 (Apache-2.0).
// All numeric casts below operate on fixed, small DSP dimensions and preserve
// the reference implementation's index and interpolation behavior.
#![allow(
...
use super::biquad::{BiquadFilter, AUP_PE_A_4KHZ, AUP_PE_B_4KHZ, AUP_PE_G_4KHZ};
