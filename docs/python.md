...
Supported model names are `silero`, `pyannote`, `pulsevad`, `fsmn`, `ten`, and `marblenet`. Pass `quantized=True` for the PulseVAD, FSMN, or MarbleNet INT8 model. PyAnnote, FSMN, TEN, and all INT8 variants require `runtime="onnxruntime"`.
